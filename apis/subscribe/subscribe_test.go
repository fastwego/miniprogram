...
func TestAddTemplate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotResp, err := AddTemplate(tt.args.ctx, tt.args.payload)
...
func TestGetPubTemplateKeyWordsById(t *testing.T) {
	...
	var resp []byte
	test.MockSvrHandler.HandleFunc(apiGetPubTemplateKeyWordsById, func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(resp))
	})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			resp = mockResp[tt.name]
			gotResp, err := GetPubTemplateKeyWordsById(tt.args.ctx)
			//fmt.Println(string(gotResp), err)
			if (err != nil) != tt.wantErr {
			...
			if !reflect.DeepEqual(gotResp, tt.wantResp) {
				t.Errorf("GetPubTemplateKeyWordsById() gotResp = %v, want %v", gotResp, tt.wantResp)
			}
		})
	}
}
func TestGetPubTemplateTitleList(t *testing.T) {
	mockResp := map[string][]byte{
		"case1": []byte("{\"errcode\":0,\"errmsg\":\"ok\"}"),
	}
	var resp []byte
	test.MockSvrHandler.HandleFunc(apiGetPubTemplateTitleList, func(w http.ResponseWriter, r *http.Request) {
		w.Write([]byte(resp))
	})
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			resp = mockResp[tt.name]
			gotResp, err := GetPubTemplateTitleList(tt.args.ctx)
			//fmt.Println(string(gotResp), err)
			if (err != nil) != tt.wantErr {
			...
			if !reflect.DeepEqual(gotResp, tt.wantResp) {
				t.Errorf("GetPubTemplateTitleList() gotResp = %v, want %v", gotResp, tt.wantResp)
			}
		})
	}
}
